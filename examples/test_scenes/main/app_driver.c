...
#define OUTPUT_GPIO_RED   3 // CONFIG_EXAMPLE_OUTPUT_GPIO_RED is documented as 3, but its actually 2, worried GPIO2 is a strapping pin so using 3
#define OUTPUT_GPIO_GREEN CONFIG_EXAMPLE_OUTPUT_GPIO_GREEN // 4
#define OUTPUT_GPIO_BLUE  CONFIG_EXAMPLE_OUTPUT_GPIO_BLUE // 5
